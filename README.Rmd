...
A full set of examples and analyses performed using `StrainSpy` are available at \url{https://sudaraka88.github.io/strainspy-manuscript/}
...
`StrainSpy` provides a function `merge_sylph_files()` to combine multiple Sylph output files into a single file. Alternatively, you can do this in bash. See [below](#running-sylph-on-an-hpc-cluster).
